<template>
  <div class="home">
      <div class="banner mb-3 clearfix">
        <img src="../assets/banner1.png" class="img-fluid">
        <!-- <div class="ban-text">舊物傳情</div>
        <div class="ban-text2">本平台期望透過便利的金物流及捐贈單管理</div>
        <div class="ban-text3">使閒置資源再次流動，正確地將物資分享給需要的人</div> -->
      </div>
      <div class="main mb-5">
